...
globalkeys = my_table.join(
    ...
    awful.key({ modkey,         }, "b", function () awful.spawn( "google-chrome-beta" ) end,
              {description = "Launch Google", group = "awesome"}),
    ...
    -- Run Launcher 1
    awful.key({ modkey,         }, ";", function () awful.util.spawn("krunner") end,
      {description = "Run Krunner", group = "hotkeys"}),
